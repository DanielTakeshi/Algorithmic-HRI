...
Figure~\ref{fig:human_dqn_performance}, except that a moving average is not
used, and that the exploration period is 10x longer and the number of epochs has
been reduced from 200 to 80.  (The exploration phase ``ends'' after epoch 40,
which is when $\epsilon=0.1$.)
}
